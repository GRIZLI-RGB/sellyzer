...
// 			classNames={{
// 				modal: clsx(
// 					"rounded-lg shadow-lg overflow-hidden bg-white dark:bg-neutral-900 backdrop-blur-md",
...
// 			<button
// 				onClick={onClose}
// 				className="absolute top-3 right-3 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-neutral-700 transition-base"
// 			>
